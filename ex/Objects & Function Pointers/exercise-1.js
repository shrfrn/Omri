...
const movies = [
  ...
  /* 
  Find a Movie by ID 
  Write a function findMovieById(movies, id) that 
  takes the movies array and an id as arguments 
  and returns the movie object with the matching id.
  */
  ...
  console.log(findMovieById(movies, 1));
  console.log(findMovieById(movies, 2));
  console.log(findMovieById(movies, 3));
  console.log(findMovieById(movies, 4));
  console.log(findMovieById(movies, 5));
  console.log(findMovieById(movies, 6));
  console.log(findMovieById(movies, 7));
  console.log(findMovieById(movies, 8));    
  console.log(findMovieById(movies, 9));